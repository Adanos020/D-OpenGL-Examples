...
public:
    ...
    void opCall()
    {
        ...
        shader_.loadVertex("source/mixedtextures/vertexShader.vert");
        shader_.loadFragment("source/mixedtextures/fragmentShader.vert");
        shader_.compile();
        shader_.create();
