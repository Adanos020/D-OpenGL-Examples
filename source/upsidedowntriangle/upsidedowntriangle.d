...
// shader sources
    ...
    void loadShaders()
    {
        ...
        load("source/upsidedowntriangle/vertexShader.vert", vertexSRC);
        load("source/upsidedowntriangle/fragmentShader.frag", fragmentSRC);
    }
}

///
struct UpsideDownTriangleApp
{
public:
///
    void run()
...
private:
    ...
    void initWindow()
    {
        ...
        window = glfwCreateWindow(800, 600, "Upside Down Triangle!", null, null);
