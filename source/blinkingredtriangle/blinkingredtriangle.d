...
// shader sources
    ...
    void loadShaders()
    {
        ...
        load("source/blinkingredtriangle/vertexShader.vert", vertexSRC);
        load("source/blinkingredtriangle/fragmentShader.frag", fragmentSRC);
    }
}

///
struct BlinkingRedTriangleApp
{
public:
///
    void run()
...
private:
    ...
    void initWindow()
    {
        ...
        window = glfwCreateWindow(800, 600, "Blinking Red Triangle!", null, null);
    ...
    void initRender()
    {
        ...
        triangle.uniColor = glGetUniformLocation(triangle.shaderProgram, "triangleColor");
    ...
    void mainLoop()
    {
        ...
        {
            auto delta = clock.currTime - start;
            glUniform3f(triangle.uniColor, (sin(delta.total!"msecs" * 0.004) + 1) / 2, 0.0, 0.0);
