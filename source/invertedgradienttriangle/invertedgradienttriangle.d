module invertedgradienttriangle;
...
// shader sources
    ...
    void loadShaders()
    {
        ...
        load("source/invertedgradienttriangle/vertexShader.vert", vertexSRC);
        load("source/invertedgradienttriangle/fragmentShader.frag", fragmentSRC);
    }
}

///
struct InvertedGradientTriangleApp
{
public:
///
    void run()
...
private:
    ...
    void initWindow()
    {
        ...
        window = glfwCreateWindow(800, 600, "Inverted Gradient Triangle!", null, null);
